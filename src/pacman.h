...
namespace Pacman
{
	...
	// 用玩家ID换取格子上玩家的二进制位
	static const GridContentType playerID2Mask[] = { player1, player2, player3, player4 };
	...
	static const GridStaticType direction2OpposingWall[] = { wallNorth, wallEast, wallSouth,
		wallWest };
